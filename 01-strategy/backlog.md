...
- [x] ~~**🗓️ 2026-05-15 · Catálogo público SEO — Fase 1 + 2**~~ — implementado 2026-05-16
  - ✅ 5 páginas por familia: `/materiales/{sinterizado,cuarzo,granito,cuarcita,marmol}/`
  - ✅ 5 guías técnicas: `/guias/{regrueso,bacha-armada,diferencia-materiales,que-necesito,cuanto-sale}/`
  - ✅ 2 index pages: `/materiales/`, `/guias/`
  - ✅ `sitemap.xml` + `robots.txt` actualizado
  - ✅ CSS compartido en `/assets/seo-pages.css`
  - Ver decision-log: `2026-05-16-catalogo-seo-publico-y-whatsapp-attribution.md`

- [ ] **Catálogo SEO — Fase 3: páginas individuales por material**
  - Solo para top 30-50 con búsqueda real (decidir con data de Google Search Console)
  - Pre-requisito: 30-60 días de tráfico medido
  - Patrón: `/materiales/sinterizado/dekton-kelya/`, `/materiales/cuarzo/silestone-calacatta-gold/`
  - Generator script Python que lee `COLORS_DB` + template

- [ ] **Catálogo público — cargar marcas pendientes en `/dekton/`, `/silestone/`, `/neolith/`**
  - Dekton: ✅ 42 colores cargados con clasificación por tipo (2026-05-16)
  - Silestone: pendiente — esperar zip del cliente
  - Neolith: pendiente — esperar zip del cliente
  - Guidoni: pendiente cargar colores faltantes
  - Cuarcita: pendiente — crear categoría propia en COLORS_DB + agregar al catálogo

- [ ] **Google Search Console** — verificar propiedad, enviar sitemap, monitorear keywords
