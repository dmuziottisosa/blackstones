    ...
    foreach (scandir(BS_CLIENTES_DIR) as $f) {
        ...
        foreach ($cliente['cotizaciones'] ?? [] as $cot) {
            ...
            if ($estado === 'entregado') {
                ...
                // No-entregado: si no hay entregado activo Y no se modificó hace >180 días → borrar
