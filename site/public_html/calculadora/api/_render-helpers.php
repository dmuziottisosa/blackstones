...
function bs_render_html_summary($cliente_obj, $cot_data, $opts = []) {
    ...
    echo '<div style="margin-bottom:4px"><b style="color:#C4A77D">●</b> Incluye fabricación, traslado e instalación de los trabajos detallados, junto con <b>zócalos perimetrales de hasta 5 cm sin costo adicional</b>.</div>';
